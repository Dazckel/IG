...
_cube::_cube(float Size)
{
  ...
  Triangles[0]=_vertex3ui(4,5,0);
  Triangles[1]=_vertex3ui(5,1,0);
  Triangles[2]=_vertex3ui(0,1,3);
  Triangles[3]=_vertex3ui(1,2,3); 

  Triangles[4]=_vertex3ui(3,2,7);
  Triangles[5]=_vertex3ui(2,6,7);
  Triangles[6]=_vertex3ui(6,7,4);
  Triangles[7]=_vertex3ui(6,5,4); 
